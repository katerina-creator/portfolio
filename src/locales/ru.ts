...
export const ru = {
  ...
  results: {
    ...
    items: [
      ...
      'Автоматическая генерация и фильтрация торговых сигналов',
      'Система приоритизации (~50+ активных сигналов одновременно)',
      'Лента сигналов с историей и жизненным циклом',
      'Детализация сигналов: контекст, метрики, причины',
      'Оценка качества сигналов по стратегиям',
      'Аналитика рынка: тренды, режимы, волатильность, импульс',
      'Контроль pipeline: ingestion → обработка → сигналы → аналитика',
    ],
  },
